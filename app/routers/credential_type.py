...
from app.schemas import SecuredDocument, SignedCredentialType
from app.schemas.web_requests import (
    RegisterCredentialTypeRequest,
    RegisterCredentialTypeResponse,
)
from app.schemas.mappings import VCRCredentialType
...
response_model = {
    "response_model": RegisterCredentialTypeResponse,
...
async def register_credential_type(
    ...
    try:
        ...
        # Find matching issuer entry from the list of known issuers
        issuer = next(
